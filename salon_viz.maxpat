...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 605.0, 246.0, 122.0, 63.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1002.0, 464.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1002.0, 579.0, 148.0, 22.0 ],
					"style" : "",
					"text" : "shape 0, freq 420, fm -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1046.0, 512.0, 104.0, 22.0 ],
					"style" : "",
					"text" : "shape 2, freq 120"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 605.0, 14.0, 317.0, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 616.0, 347.0, 264.0, 181.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 605.0, 110.0, 317.0, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1101.0, 14.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "r draw"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1101.0, 58.0, 160.0, 129.0 ],
					"pic" : "blodge_logo_2.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 261.0, 19.0, 230.0, 125.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 53.0, 484.0, 258.0, 102.0 ],
					"varname" : "vs_mixer_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 19.0, 19.0, 230.0, 125.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 48.0, 637.0, 160.0, 120.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 117.0, 155.0, 20.0 ],
					"style" : "",
					"text" : "1) drag and drop any video."
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-6::obj-13" : [ "mixer6_in_4", "IN4", 0 ],
			"obj-5::obj-35" : [ "shapewfg_freq_range", "scale_freq", 0 ],
			"obj-6::obj-18" : [ "mixer3_master", "MASTER", 0 ],
			"obj-5::obj-130" : [ "shapewfg_time", "time", 0 ],
			"obj-2::obj-4::obj-20" : [ "live.tab[2]", "live.tab[1]", 0 ],
